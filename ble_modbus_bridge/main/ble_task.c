...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        rsp.attr_value.value[0] = 11+increment_add_value;
        rsp.attr_value.value[1] = 22+increment_add_value;
        rsp.attr_value.value[2] = 33+increment_add_value;
        rsp.attr_value.value[3] = 44+increment_add_value;
