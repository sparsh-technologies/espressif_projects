...
typedef enum {
    ...
    FSM_STATE_FW_REBOOT_MSG_SENDING,
    FSM_STATE_FW_REBOOT_MSG_ACKNOWLEDGED,
    ...
    FSM_STATE_TEST_REMOTE_IN_PROGRESS,
    FSM_STATE_TEST_REMOTE_COMPLETE,
    FSM_STATE_PROGRAM_NEW_REMOTE_IN_PROGRESS,
    FSM_STATE_PROGRAM_NEW_REMOTE_COMPLETE,
    FSM_STATE_SITE_SPECIFIC_STATUS_IN_PROGRESS,
    FSM_STATE_SITE_SPECIFIC_STATUS_COMPLETE,
    FSM_STATE_TRIP_INFO_STATUS_IN_PROGRESS,
    FSM_STATE_TRIP_INFO_STATUS_COMPLETE
