...
typedef enum {
    ...
    FSM_STATE_CFG_SET_HELP_NUM_SENDING,
    FSM_STATE_CFG_SET_HELP_NUM_RECEIVED,
    FSM_STATE_ACTIVATE_IN_PROGRESS,
    FSM_STATE_ACTIVATE_COMPLETE,
    ...
    FSM_STATE_WIFI_MODE_SET_IN_PROGRESS,
    FSM_STATE_WIFI_MODE_SET_COMPLETE
